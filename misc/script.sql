...
ALTER TABLE Flashcard ADD OrderIndex INT NOT NULL DEFAULT 0;
ALTER TABLE Flashcard ADD Status BIT NOT NULL DEFAULT 1;
ALTER TABLE FlashcardGroup ADD Status BIT NOT NULL DEFAULT 1;
ALTER TABLE Lesson ADD Status BIT NOT NULL DEFAULT 1;
ALTER TABLE LessonGroup ADD Status BIT NOT NULL DEFAULT 1;
ALTER TABLE GrammarPoint ADD Status BIT NOT NULL DEFAULT 1;