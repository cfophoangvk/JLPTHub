<%@ tag description="Dialog" pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>

<%@ attribute name="id" required="true" type="java.lang.String" description="Unique ID to trigger this dialog" %>
<%@ attribute name="className" required="false" type="java.lang.String" %>

<dialog id="${id}" class="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 m-0 gap-4 border bg-background p-6 shadow-lg duration-200 sm:rounded-lg text-foreground backdrop:bg-black/80 open:!mt-0 ${className}">
