...
<dialog id="${id}" class="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 m-0 border bg-background p-6 shadow-lg duration-200 sm:rounded-lg text-foreground backdrop:bg-black/80 open:!mt-0 ${className}">
