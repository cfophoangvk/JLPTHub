...
<layout:mainLayout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            <ui:td>
                                <c:choose>
                                    <c:when test="${not empty lesson.description}">
                                        <span class="truncate max-w-xs block" title="${lesson.description}">
                                            ${lesson.description.length() > 50 ? lesson.description.substring(0, 50).concat('...') : lesson.description}
                                        </span>
                                    </c:when>
                                    <c:otherwise>
        ...
        <!-- Delete Form -->
        <form id="deleteForm" action="${pageContext.request.contextPath}/admin/lessons/delete" method="POST">
            ...
            <ui:alertDialogHeader>
                ...
                <ui:alertDialogDescription>
                    <div class="text-center text-muted-foreground">
                        ...
                        <span class="text-red-600 font-semibold">(LƯU Ý: Tất cả điểm ngữ pháp trong bài học cũng sẽ bị xóa vĩnh viễn.)</span>
                    </div>
                </ui:alertDialogDescription>
            </ui:alertDialogHeader>
